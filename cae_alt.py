...
def main_cae():
    option = [1, 2]
    epochs_ab = 8500 # 100, 500, 1000, 10000
    max_ab = 1526
    min_ab = 403
    ...
    for i in range(0,2):
        if option[i] == 1:
            ...
            data_train_num_a = 17 # Tamanho do conjunto de treinamento
            data_test_num_a = 22 # Última amostra do conjunto de teste
        ...
        #    print(min_a)
            ...
            data_train_num_b = 17 # Tamanho do conjunto de treinamento
            data_test_num_b = 22 # Última amostra do conjunto de teste
