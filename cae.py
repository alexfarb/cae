...
epochs_num_a = 800 # Quantidade de Épocas para o Treinamento da Rede
...
decoded_train_a, train_error_a = auto_encoder_a.convolutional_autoencoder_1d(kernel_size_a, epochs_num_a, optimizer_a, loss_a)
