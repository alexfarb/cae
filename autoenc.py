...
class Autoencoder(object):
    ...
    def autoencoder_1d(self, kernel_size, epochs_num, optimizer_option, loss_option, autoenc_name):
        ...
        x_train = self.input_train # Redimensionamento da entrada (treino) para o CAE
        y_train = self.output_train # Redimensionamento da saída (treino) para o CAE
        x_test = self.input_test # Redimensionamento da entrada (teste) para o CAE
        y_test = self.output_test# Redimensionamento da saída (teste) para o CAE
        # Camadas para o encoder
        input_signal = Input(shape=(self.data_length,))
        encoded = Dense(4, activation='relu')(input_signal)
        
        # Camada para o Decoder
        decoded = Dense(self.data_length, activation='sigmoid')(encoded)
...
def main_autoenc():
    option = [1, 2]
    epochs_ab = 50000 # 100, 500, 1000, 10000
    max_ab = 1526
    min_ab = 403
    ...
    for i in range(0,2):
        if option[i] == 1:
            ...
            cae_name_a = 'C:\\repos\\cae\saved_models\\autoenc_a.h5'
        ...
        #    print(min_a)
            ...
            decoded_train_a, decoded_test_a, loss_train_a, loss_test_a = auto_encoder_a.autoencoder_1d(kernel_size_a, epochs_num_a, optimizer_a, loss_a, cae_name_a)
            ...
            cae_name_b = 'C:\\repos\\cae\saved_models\\autoenc_b.h5'
            # Divisão em treino e teste
        ...
        #    min_b = input_train_b.min()
            ...
            decoded_train_b, decoded_test_b, loss_train_b, loss_test_b = auto_encoder_b.autoencoder_1d(kernel_size_b, epochs_num_b, optimizer_b, loss_b, cae_name_b)
